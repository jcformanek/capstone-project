...
urlpatterns = [
    ...
    path('postgrad/qualification/select_country', select_country_view, name='postgrad_select_country'),
    path('postgrad/qualification/edit/<str:country>', edit_qualification_view, name='postgrad_edit_qualification'),
